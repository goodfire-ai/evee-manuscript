#!/usr/bin/env python3
"""
Figure 2A — Placeholder for interpretability framework schematic (external).

The actual schematic is produced outside this pipeline and composited
into the final figure manually.
