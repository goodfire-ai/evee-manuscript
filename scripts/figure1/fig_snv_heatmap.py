#!/usr/bin/env python3
"""
SNV heatmap — ClinVar pathogenicity prediction across SNV consequence types.
...
Output: figures/figure1/panels/fig_snv_heatmap.{png,pdf}
"""
import sys
...
OUT_STEM = ROOT / "figures" / "figure1" / "panels" / "fig_snv_heatmap"
...
def plot(ax, aspect="equal"):
    ...
    strat_df = pl.read_ipc(ARTIFACTS / "snv_benchmark.feather")
    df = prepare(strat_df)
    plot_heatmap(ax, df, "auroc", aspect=aspect)


# ── Shared cell sizing (must match indel heatmap) ─────────────────
