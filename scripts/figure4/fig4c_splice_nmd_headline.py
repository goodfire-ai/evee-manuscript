#!/usr/bin/env python3
"""
Figure 4c — EVEE RNA-seq validation summary.
...
Input:  artifacts/splice_nmd_validation_per_variant.csv
        (one row per unique variant; "Validated" boolean per row).

Output: figures/figure4/fig4c_splice_nmd_headline.{png,pdf}

Run:
    uv run python scripts/figure4/fig4c_splice_nmd_headline.py
"""
import sys
...
CSV      = ROOT / "artifacts" / "splice_nmd_validation_per_variant.csv"
OUT_STEM = ROOT / "figures" / "figure4" / "fig4c_splice_nmd_headline"
...
def main():
    ...
    groups = [
        ...
        ("Intronic",          intronic, CONSEQ_COLORS["Intronic"],  None),
    ...
    ax.text(1.0, 112, "By mechanism", ha="center", fontsize=7,
            color="#666666", style="italic")
    ax.text(3.5, 112, "By zygosity", ha="center", fontsize=7,
            color="#666666", style="italic")
