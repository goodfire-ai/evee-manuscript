#!/usr/bin/env python3
"""
Supplementary Figure — gene-level distribution of EVEE pathogenicity scores in the Mayo RA cohort.
...
Input:  artifacts/ra_cohort.feather (de-identified: gene, pathogenicity, candidate_bin)
Output: figures/supplement/supfig_ra_cohort.{png,pdf}
"""
import sys
...
def load_uncertain() -> pl.DataFrame:
    df = pl.read_ipc(ARTIFACTS / "ra_cohort.feather")
