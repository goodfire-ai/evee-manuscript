#!/usr/bin/env python3
"""
Supplementary Figure — Auto-interpretation per-axis score breakdown.
...
Companion to Figure 2E which shows the composite score.

Progression: Coord only → +Gene → +Other context → +HGVSp → +Evo2 predictions

Input:  artifacts/supfig_autointerp_axes.feather
Output: figures/supplement/supfig_autointerp_axes.{png,pdf}
"""
import sys
...
from theme.mayo_theme import (
    apply_theme, save_figure, add_panel_label,
    FONT_SIZE_TICK, FONT_SIZE_LABEL, FONT_SIZE_TITLE, FONT_SIZE_LEGEND,
)

ARTIFACTS = ROOT / "artifacts"
OUT_STEM = ROOT / "figures" / "supplement" / "supfig_autointerp_axes"
