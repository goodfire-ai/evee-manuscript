#!/usr/bin/env python3
"""
Figure 1E — UMAP of CovarianceProbe embeddings.

Two panels:
  Left:  colored by pathogenic (red) vs benign (blue)
  Right: colored by consequence type

Reads pre-computed UMAP from data/embeddings/umap_snv.{safetensors,feather}.
...
def plot(axes):
    """Plot Figure 1E onto a pair of axes [left, right].

    Parameters
    ----------
    axes : array-like of 2 Axes
        Left: pathogenic vs benign. Right: consequence type.
    """
