...
| c | `figure3/fig3c_mechanism_recovery.py` | Cross-gene mechanism-class recovery (5-fold CV balanced accuracy) |
...
| `brca1_e22_data.json` | Fig 4a,b | Snaptron junction read counts + variant metadata for BRCA1 exon 22 (JHOS-4, JHOS-2, A2780) |
